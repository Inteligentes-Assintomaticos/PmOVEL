...
console.log(a == b); // true porque os valores s~ao iguais, mesmo que os tipos sejam diferentes

// Operador === (valor igual e tipo igual)
console.log(a === b); // false, porque os valores sao iguais, mas os tipos sao diferentes

// Operador != (diferente de)
let c = 10;
console.log(c != '10'); // false por que os valores sao iguais, mesmo que os tipos sejam diferentes (number e string)

// Operador !== (vlor e tipo diferentes)
console.log(c !== '10'); // true, por que os tipos sao diferentes, mesmo que os valores sejam iguais

// Operador > (maior que)
let d = 15;
console.log(d > 10); // true. por que 15 é maior que 10
...
let e = 7;
console.log(e >= 7); // true por que 7 é igual a 7

// Operador <= (menor ou igual a)
console.log(e <= 8); // true, por que 7 é menor que 8
...
// Exemplo 2: Verificação de número par ou impar
let numero = 7;
let tipo = (numero % 2 === 0) ? 'Par' : 'Impar';

console.log('O número é: '+ tipo); // Ímpar por que 7 é impar
...
console.log('Status da compra: ' + podeComprar); // Saldo insuficiente, por que o saldo é menor que o valor da compra
...
// Operador - (subtração)
let subtracion = x - y;
console.log('Subtração: ' + subtracion); // 5
...
// Operador AND (&&)
let andResult = m && n;
console.log('AND (true && false: ' + andResult); // False, por que ambos os operandos não são verdadeiros

// Operador OR (||)
let orResult = m || n;
console.log('OR (true || false): ' + orResult); // True, por que pelo menos um dos operandos é verdadeiro

// Operador NOT (!)
let notResult = !m;
console.log('NOT (!true): ' + notResult); // False por que inverte o valor booleano

// Combinação de operadores lógicos
let complexResult = (p < q) && (m || n);
console.log('Exemplo ((10 < 20) && (true || false)): ' + complexResult); // True por que 10 é menor que 20 e a expressão OR é verdadeira

// Mais um exemplo com operadores lógicos
let r = 5;
let s = 15;
let complexResult2 = (r > 0) && (s > 10) || !b;
console.log('Outro exemplo: ((5 > 0) && (15 >  10) || !false)): ' + complexResult2); // True, por que todas as condições são verdadeiras
